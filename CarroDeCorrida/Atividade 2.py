...
car = CarroCorrida(10, "Fabrício", "McLaren", 120.00, 0.00, False)
print(f"{car.getPiloto()} - {car.getEquipe()} - {car.getVelocidadeMaxima()}")
car.setVelocidadeMaxima(100.00)
car.ligar()
car.acelerar(120.00)
car.acelerar(90.00)
car.frear(10)
print(f"Velocidade Atual: {car.getVelocidadeAtual()}")
car.desligar()
car.parar()
car.desligar()